...
class PostLikeApiView(APIView):
    ...
    def post(self, request, pk):
        try:
            ...
            data = {
                'success': True,
                'message': "LIKE muvaffiqatli qo'shildi",
    ...
    def delete(self, request, pk):
        try:
            ...
            data = {
                'success': True,
                'message': "LIKE muvaffiqatli o'chirildi",
                'data': None
            }
            ...
            data = {
                'success': True,
                'message': "Postga LIKE muvaffiqiyatli qo'shildi",
                'data': serializer.data
            }
            return Response(data, status=status.HTTP_201_CREATED)
...
class CommentLikeApiView(APIView):
    ...
    def delete(self, request, pk):
        try:
            ...
            data = {
                'success': True,
                'message': "LIKE muvaffiqiyatli qo'shildi",
                'data': serializer.data
            }
            return Response(data, status=status.HTTP_201_CREATED)
